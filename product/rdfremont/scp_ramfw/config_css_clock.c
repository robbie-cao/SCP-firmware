 ...
 */
static const struct mod_css_clock_rate rate_table_cpu[] = {
    {
        .rate = 2300 * FWK_MHZ,
...
static const struct fwk_element css_clock_element_table[] = {
    CSS_CLOCK_DEV_CPU(0),        CSS_CLOCK_DEV_CPU(1),
    CSS_CLOCK_DEV_CPU(2),        CSS_CLOCK_DEV_CPU(3),
#if (PLATFORM_VARIANT == 0 || PLATFORM_VARIANT == 1)
    CSS_CLOCK_DEV_CPU(4),        CSS_CLOCK_DEV_CPU(5),
    CSS_CLOCK_DEV_CPU(6),        CSS_CLOCK_DEV_CPU(7),
#endif
#if (PLATFORM_VARIANT == 0)
    CSS_CLOCK_DEV_CPU(8),        CSS_CLOCK_DEV_CPU(9),
    CSS_CLOCK_DEV_CPU(10),       CSS_CLOCK_DEV_CPU(11),
    CSS_CLOCK_DEV_CPU(12),       CSS_CLOCK_DEV_CPU(13),
    CSS_CLOCK_DEV_CPU(14),       CSS_CLOCK_DEV_CPU(15),
#endif
