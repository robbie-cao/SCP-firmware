...
struct mod_mhu3_channel_config lcp_ap_channel_config[] = {
    ...
    MOD_MHU3_INIT_FCH(1, 0, MOD_MHU3_FCH_DIR_IN),
    MOD_MHU3_INIT_FCH(2, 0, MOD_MHU3_FCH_DIR_IN),
};
...
static const struct fwk_element element_table[] = {
    ...
    [MHU3_DEVICE_IDX_LCP_AP_FCH_DVFS_SET_LIM_MIN] = {
        .name = "AP-LCP FCH DVFS SET LIMIT MIN",
        .sub_element_count = 1,
        .data = &(struct mod_mhu3_device_config) {
            .irq = (unsigned int) MHU3_AP2LCP_IRQ_PBX_COMBINED,
            .in = LCP_AP_MHU_MBX_BASE,
            .channels = &lcp_ap_channel_config[1],
        },
    },
    [MHU3_DEVICE_IDX_LCP_AP_FCH_DVFS_SET_LIM_MAX] = {
        .name = "AP-LCP FCH DVFS SET LIMIT MAX",
        .sub_element_count = 1,
        .data = &(struct mod_mhu3_device_config) {
            .irq = (unsigned int) MHU3_AP2LCP_IRQ_PBX_COMBINED,
            .in = LCP_AP_MHU_MBX_BASE,
            .channels = &lcp_ap_channel_config[2],
        },
    },
