...
static_assert(
    FWK_ARRAY_SIZE(sds_module_regions) == SCP_CFGD_MOD_SDS_REGION_IDX_COUNT,
...
const struct mod_sds_config sds_module_config = {
    ...
    .clock_id =
        FWK_ID_ELEMENT_INIT(FWK_MODULE_IDX_CLOCK, CFGD_MOD_CLOCK_EIDX_CMN),
};
