...
#include <internal/atu_transport.h>
    ...
    uint8_t *region_idx)
{
    ...
    /*
     * The security subsystem firmware returns the response and the region
     * index for the requested translation region, upon successful mapping.
     * Return the index of the region back to the caller.
     */
