...
struct mod_atu_api {
     ...
     *      payload buffer.
     * \retval ::FWK_E_TIMEOUT No response from security subsystem firmware.
     ...
     *      region.
     * \retval ::FWK_E_BUSY The previous message was not read by security
     *      subsystem firmware.
     * \retval ::FWK_E_DATA Error in the response message received from the
     *      security subsystem firmware.
     */
    int (*add_region)(
