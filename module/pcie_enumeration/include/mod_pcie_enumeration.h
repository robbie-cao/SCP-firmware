...
#ifndef MOD_PCIE_ENUMERATION_H
#define MOD_PCIE_ENUMERATION_H
...
/*!
 * \brief APIs to preform memory read and write operations.
 */
struct pcie_enumeration_rw_api {
    /*!
     * \brief Read a byte from the given memory address
     *
     * \param addr Memory address
     *
     * \return byte value read from the memroy address
     */
     ...
     * \param addr Memory address
     *
     * \return word value read from the memroy address
     */
...
struct mod_pcie_enumeration_api {
    /*!
    ...
    int (*calculate_resource)(
        ...
        struct pcie_mmap_size *config,
        uint8_t primary_bus_number,
        struct pcie_enumeration_rw_api *rw_api);
};

#endif /* MOD_PCIE_ENUMERATION_H */
