...
/*
 * MAX ECAM space
 * MAX ECAM spcae per bus * Max numbers of bus(256)
 */
...
const struct fwk_module_config config_pcie_enumeration = { 0 };

struct pcie_enumeration_rw_api default_rw_api = {
    .read8 = read8,
    .write8 = write8,
    .read32 = read32,
    .write32 = write32,
...
static void get_mmio_memory_size(
    ...
    struct pcie_enumeration_rw_api *rw_api,
    uint8_t num_bar)
{
    uint8_t idx;
...
static int pcie_enumeration_init(
    fwk_id_t module_id,
    unsigned int unused,
    const void *unused2)
{
...
static struct mod_pcie_enumeration_api pcie_enumeration_api = {
    .calculate_resource = calculate_resource,
};

static int pcie_enumeration_process_bind_request(
    ...
    const void **api)
{
    ...
    *api = &pcie_enumeration_api;
    return FWK_SUCCESS;
}

const struct fwk_module module_pcie_enumeration = {
    .type = FWK_MODULE_TYPE_SERVICE,
    .api_count = 1,
    .event_count = 0,
    .init = pcie_enumeration_init,
    .process_bind_request = pcie_enumeration_process_bind_request,
};
